...
def app() -> Generator[Flask, None, None]:
    ...
    # Set Redis config for tests
    os.environ["REDIS_HOST"] = "localhost"
    os.environ["REDIS_PORT"] = "6379"
    os.environ["REDIS_DB"] = "15"  # Use different DB for tests
    os.environ["REDIS_PASSWORD"] = ""
    
    # Mock Redis check in create_app
    ...
    try:
        ...
        # Allow JWT in both cookies and headers for testing
...
def mock_external_services(mocker, mock_redis):
    ...
    # Mock security_service to avoid real security checks in tests
    ...
    # Mock activity_service to avoid real activity logging in tests
    ...
    # Mock Redis for connect_service (imported inside method)
    mocker.patch("redis.Redis", return_value=mock_redis)
    
    # Mock analytics tracker - will be patched per-test if needed
    # The autouse fixture will ensure basic mocks are in place
...
def mock_redis(mocker):
    ...
    # Create a proper context manager for pipeline
