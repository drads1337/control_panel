          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder={isEdit ? "Leave empty to keep current token, or enter new token" : "123456789:ABCdefGHIjklMNOpqrsTUVwxyz"}
                className="flex-1"
              />
              <Button
                variant="outline"
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder={isEdit ? "Leave empty to keep current token, or enter new token" : "MTIzNDU2Nzg5MDEyMzQ1Njc4OQ..."}
                className="flex-1"
              />
              <Button
                variant="outline"
      ...
      <div>
        ...
        <div className="flex gap-2">
          <Input
            ...
            placeholder={isEdit ? "Leave empty to keep current secret, or enter new secret" : "Webhook secret for signing"}
            className="flex-1"
          />
          <Button
            variant="outline"
