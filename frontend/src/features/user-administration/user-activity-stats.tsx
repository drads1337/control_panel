...
export function UserActivityStats({ 
  ...
  const formatLastActivity = (dateString: string | null) => {
    ...
    // Use formatRelativeTime for relative formatting, fallback to date for older dates
    const relative = formatRelativeTime(dateString);
    // If it's more than a year, show a shorter date format
    if (relative.includes('y ago')) {
