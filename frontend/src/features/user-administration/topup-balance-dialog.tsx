    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 gap-0">
        ...
        <Tabs
          ...
          className="px-4 pb-4"
        >
          <TabsList className="grid w-full grid-cols-3 h-8 mb-3 **:data-[slot=tabs-trigger]:text-xs">
          ...
          <TabsContent value="topup" className="space-y-3 outline-none mt-0">
            ...
            <div className="flex justify-end gap-2 pt-2">
              <Button variant="ghost" size="sm" className="h-7 text-xs" onClick={() => onOpenChange(false)} disabled={loading}>
                Cancel
              </Button>
              <Button 
                size="sm"
                  ...
                  <tbody className="divide-y">
                    {transactionsLoading && transactions.length === 0 ? (
                      ...
                      transactions.map((t) => (
                        ...
                        <td
                          className={`p-2 text-right font-sans ${
                            t.type === "credit"
                              ? "text-green-600"
                              : "text-red-600"
                          }`}
