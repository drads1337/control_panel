...
import { useOwnerDashboard, OwnerDashboardStats } from '@/features/dashboard/hooks/use-owner-dashboard'
...
const TopCountriesCard = React.lazy(() => import('../top-countries-card').then(module => ({ default: module.TopCountriesCard })))
      ...
      case 'dashboard':
        return (
          <>
            ...
            <Suspense fallback={<div className="flex items-center justify-center min-h-[250px] sm:min-h-[400px]"><Spinner size="lg" message="Loading map..." /></div>}>
              <Card>
                ...
                <CardContent className="p-4 sm:p-6">
                  <CountriesMap data={data as DashboardData} height={400} />
                </CardContent>
              </Card>
            </Suspense>
              ...
              <Suspense fallback={<div className="flex items-center justify-center min-h-[250px] sm:min-h-[400px]"><Spinner size="lg" message="Loading map..." /></div>}>
                <div className="w-full">
                  <Card>
                    ...
                    <CardContent className="p-4 sm:p-6">
                      <CountriesMap data={data as OwnerDashboardStats} height={400} />
                    </CardContent>
                  </Card>
                </div>
              </Suspense>
