      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div className="text-center py-2">
            ...
            <p className="text-sm text-muted-foreground mt-1">Project Subscription</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/50">
              ...
              <Badge variant={urgencyLevel === 'critical' ? 'destructive' : urgencyLevel === 'high' ? 'secondary' : 'outline'}>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/50">
              ...
              <span className="text-xs text-muted-foreground">Immediate access</span>
            </div>
          </div>
