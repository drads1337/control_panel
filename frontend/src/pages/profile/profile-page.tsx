...
import { UserActivityList } from '@/features/user-administration/user-activity-list'
import { ProfileCard } from '@/features/profile/profile-card'
import { ProfileGeneralTab } from '@/features/profile/profile-general-tab'
import { ProfileSecurityTab } from '@/features/profile/profile-security-tab'
    ...
    <div className="space-y-3 xs:space-y-4 sm:space-y-5 md:space-y-6 px-2 xs:px-3 sm:px-4 md:px-0">
      ...
      <div className="mb-3 xs:mb-4 sm:mb-5 md:mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl xs:text-2xl sm:text-2xl md:text-3xl font-bold tracking-tight text-foreground leading-tight">My Profile</h1>
