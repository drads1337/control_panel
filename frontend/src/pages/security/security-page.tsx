...
import { SecurityPermissionsProvider, useSecurityPermissions } from '@/app/providers/security-permissions-provider';
...
import { SecurityAccessDenied } from '@/features/security-rules/security-access-denied';
