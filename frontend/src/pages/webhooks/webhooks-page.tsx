...
import { WebhookTable } from '@/features/webhooks-control/webhook-table'
import { WebhookStats } from '@/features/webhooks-control/webhook-stats'
import { CreateWebhookDialog } from '@/features/webhooks-control/create-webhook-dialog'
import { EditWebhookDialog } from '@/features/webhooks-control/edit-webhook-dialog'
import { WebhookLogsDialog } from '@/features/webhooks-control/webhook-logs-dialog'
import { WebhookAccessDenied } from '@/features/webhooks-control/webhook-access-denied'
import { useWebhookActions } from '@/features/webhooks-control/hooks/use-webhook-actions'
import { useWebhookDialogs } from '@/features/webhooks-control/hooks/use-webhook-dialogs'
import { WebhooksPageHeader } from '@/features/webhooks-control/components/webhooks-page-header'
import { ConditionalRender } from '@/lib/rbac/conditional-render'
import { usePermissions } from '@/lib/hooks'
import type { WebhookData } from '@/features/webhooks-control/types'
