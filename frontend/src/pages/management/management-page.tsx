...
import { ManagementAccessDenied, ManagementTabContent, ManagementDialogs } from '@/widgets/management';
import ManagementStats from '@/widgets/management/management-stats';
